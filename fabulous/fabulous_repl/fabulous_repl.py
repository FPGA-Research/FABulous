...
from fabulous.routing_model.generator import PLACEMENT_ESTIMATE_TEXT
...
class FABulousREPL(Cmd):
    ...
    def do_gen_routing_model(self, args: argparse.Namespace) -> None:
        ...
        pips, bel, belv2, belv3, constraints = self.fabulousAPI.generate_routing_model(
            mode=mode,
        ...
        for path, content in (
            ...
            (meta_dir / "bel.v3.txt", belv3),
            (meta_dir / "template.pcf", constraints),
            (meta_dir / "placement_estimate.txt", PLACEMENT_ESTIMATE_TEXT),
        ):
