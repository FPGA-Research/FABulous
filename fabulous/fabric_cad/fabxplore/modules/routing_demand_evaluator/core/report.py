...
_DEMAND_CATEGORIES = {
    ...
    DemandClassName.FANIN_DIVERSITY: DemandCategory.STRESS,
    DemandClassName.SOURCE_FANOUT_DIVERSITY: DemandCategory.STRESS,
    DemandClassName.SIDE_PAIR_BALANCE: DemandCategory.STRESS,
