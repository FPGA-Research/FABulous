...
Fabric 2.0 Achitecture implementation. But not using SAT only yosys TECHMAP plus packing
"""
...
class FabulousArchitecture(ArchitectureSynthesizer):
    ...
    def __init__(self, debug: bool = False) -> None:
        ...
        self.my_root: Path = self.x_root / "examples" / "plain_fraclut5_techmap"
    ...
    def synth_fabulous(self, _config: FabulousArchitectureConfig) -> None:
        ...
        self.design.run_pass("chtype -set FLUT5_1P_2PS t:LUT5")

        self.design.run_pass("clean")

        # Pack downstream registers
        ...
        # Pack the remaining registers
        self.design_materialize_registers_pass(
            tile_verilog_path=self.my_root / "count_flut5_1p_2ps.v",
            ...
            lanes=[
                {
                    ...
                    "output_port": "Q0",
                    "clock_port": "CLK",
                    "attributes": {"FF_USED": 10},
                },
                {
                    "data_port": "I1",
                    "output_port": "Q1",
                    "clock_port": "CLK",
                    "attributes": {"FF_USED": 11},
                },
            ],
    ...
    def dse_flow(self, benchmark_id: int, syth_coarse_only: bool = False) -> None:
        ...
        self.synthesize(config, syth_coarse_only=syth_coarse_only)
        self.clear_flow()
    ...
    def run_flow(self) -> None:
        ...
        for benchmark_id in range(b, b + 17):
            self.dse_flow(benchmark_id=benchmark_id, syth_coarse_only=False)
