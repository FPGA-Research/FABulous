...
class SDFTimingGraphBase:
    ...
    hier_sep : str
        Hierarchy separator used in the design If None, it will be inferred from the SDF header.
    graph : nx.DiGraph
        Directed graph representing the timing information.
    header_info : dict
    ...
    def get_interconnects(self) -> list[Component]:
        ...
        -------
        list[Component]
            List of interconnect components.
        """
    ...
    def get_sdf_data_dict(self) -> dict:
        ...
        -------
        dict
            The SDF data in dictionary format.
        """
    ...
    def get_nxgraph(self) -> nx.DiGraph:
        ...
        -------
        nx.DiGraph
            The directed graph with delay annotations.
        """
        return self.graph
    ...
    def get_reverse_nxgraph(self) -> nx.DiGraph:
        ...
        -------
        nx.DiGraph
            The reversed directed graph with delay annotations.
        """
