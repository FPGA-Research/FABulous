...
synthesised netlist. A pin that is not directly on a frame port net is reported
rather than moved, because the walk that produced the list never looked past
such a driver.
"""
