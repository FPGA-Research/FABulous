...
class PlacementOptLoop:
    ...
    GDSFlowError
        ...
        FRAME_BASED, since only frames form the crosspoint grid; if it is on
        without a `ConfigMem.csv`; or if the tile interface ordering is on
    ...
    def __init__(self, config: Config, *, growth_cap: int, no_opt: bool) -> None:
        ...
        self.active = self.config_mapping or self.tile_interface
