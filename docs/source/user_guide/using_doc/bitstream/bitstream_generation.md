...
The following command lowers the FASM representation of the placed and routed `top` design into a bitstream file.

```console
(venv)$ bit_gen -genBitstream top.fasm meta_data.txt top_output.bin
```
