...
from fabulous.fabric_definition.port import ClockPort
...
class TestBelClockPort:
    ...
    def test_user_clk_builds_clock_port(self) -> None:
        """A UserCLK port surfaces as a ClockPort and sets with_user_clock."""
        bel = Bel(
            src=Path("mod.v"),
            prefix="",
        ...
        assert isinstance(bel.user_clk_port, ClockPort)
