...
class TestFabricCompositeQueries:
    ...
    def _fabric(self, make_fabric: Callable[..., Fabric]) -> tuple[Fabric, Tile]:
        ...
        top_def.part_of_composite = True
        bot_def.part_of_composite = True
        ...
        grid_bot.part_of_composite = True
        grid_top.part_of_composite = True
    ...
    def test_get_all_unique_tiles_includes_composite_not_subtiles(
        ...
        # sub-tiles (part_of_composite) are not.
...
class TestFabricRepr:
    ...
    def test_grid_prints_north_row_before_south_row(
        ...
        south = make_empty_tile("SOUTH_TILE", pin_order_config={})
        north = make_empty_tile("NORTH_TILE", pin_order_config={})
        fabric = make_fabric(
            tile=[[south], [north]],
            numberOfRows=2,
            numberOfColumns=1,
